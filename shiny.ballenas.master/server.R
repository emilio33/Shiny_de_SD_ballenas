...
shinyServer(function(input, output, sessionInfo) {
  ...
  simul_reactive <- reactive({
    ...
    ## Cómputo en paralelo de las  Ordinary Differential Equations (ODEs) (la salida es una lista)
  ...
  ## dinámica poblacional de la ballena gris
  #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
